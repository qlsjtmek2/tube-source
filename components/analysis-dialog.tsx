          ...
          {loading ? (
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <section>
                ...
                <div className="p-4 bg-purple-50 dark:bg-purple-950/30 rounded-lg border border-purple-100 dark:border-purple-900/50 text-sm leading-relaxed">
                  {analysis.hook}
                </div>
              </section>
              ...
              <section>
                ...
                <div className="p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-100 dark:border-blue-900/50 text-sm leading-relaxed">
                  {analysis.target}
                </div>
              </section>
              ...
              <section>
                ...
                <div className="p-4 bg-green-50 dark:bg-green-950/30 rounded-lg border border-green-100 dark:border-green-900/50 text-sm leading-relaxed">
                  {analysis.structure}
                </div>
              </section>
